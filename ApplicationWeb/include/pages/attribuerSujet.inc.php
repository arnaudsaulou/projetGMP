    ...
    if (empty($_POST['choix_promotion'])) {
        ...
        <form class="form-row" action="#" method="POST">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control" id="choixDateLimite" required type="date" name="date_limite"
        ...
        if (intval($nbEtudiants) < $nbSujets) {
                ...
                <div class="attributionError">
                    <div class='row justify-content-center'>
                        <div class="col-4 align-self-center alert alert-warning" role="alert">
                            <p>L'attribution s'est déroulée sans erreur mais <?php echo $count ?> étudiants avaient déjà
                                reçu le sujet.</p>
                        </div>
                    </div>
                    <a class="btn btn-link" href="index.php?page=6"><p>Retour</p></a>
            ...
            <div class="attributionError">
                <div class='row justify-content-center'>
                    <div class="col-4 align-self-center alert alert-danger" role="alert">
                        <p>Les sujets n'ont pas pu être attribués à la promotion car il y a plus d'étudiants que de
                            sujets disponibles !</p>
                    </div>
                </div>
                <a class="btn btn-link" href="index.php?page=6"><p>Retour</p></a>
            </div>
